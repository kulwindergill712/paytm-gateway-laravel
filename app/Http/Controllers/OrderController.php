...
class OrderController extends Controller
{
	...
	public function handlePaytmRequest( $order_id, $amount ) {
		...
		$paramList["MID"] = 'ILFjRV51625048627542';
		...
		$paytm_merchant_key = 'kB#wiAtTwS0g45@4';
	...
	function getConfigPaytmSettings() {
		...
		define('PAYTM_MERCHANT_KEY', 'kB#wiAtTwS0g45@4'); //Change this constant's value with Merchant key downloaded from portal
		define('PAYTM_MERCHANT_MID', 'ILFjRV51625048627542'); //Change this constant's value with MID (Merchant ID) received from Paytm
